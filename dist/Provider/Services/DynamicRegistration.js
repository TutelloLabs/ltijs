...
class DynamicRegistration {
  constructor(
    ...
    (0, _classPrivateFieldSet2.default)(
      this,
      _hostname,
      getHostname(options.url)
    );
    (0, _classPrivateFieldSet2.default)(
      this,
      _appUrl,
      buildUrl(options.url, routes.appRoute)
    );
    (0, _classPrivateFieldSet2.default)(
      this,
      _loginUrl,
      buildUrl(options.url, routes.loginRoute)
    );
    (0, _classPrivateFieldSet2.default)(
      this,
      _keysetUrl,
      buildUrl(options.url, routes.keysetRoute)
    );
  ...
  async register(openidConfiguration, registrationToken, options) {
    ...
    const registration = {
      ...
      redirect_uris: [
        ...(0, _classPrivateFieldGet2.default)(this, _redirectUris),
        (0, _classPrivateFieldGet2.default)(this, _appUrl),
      ],
      ...
      "https://purl.imsglobal.org/spec/lti-tool-configuration": {
        ...
        custom_parameters: (0, _classPrivateFieldGet2.default)(
          this,
          _customParameters
        ),
    ...
    try {
      ...
      throw new Error(
        `REMOTE_REGISTRATION_FAILED: ${error.message} from endpoint ${configuration.registration_endpoint}` +
          tokenMessage
      );
    }
    ...
    if (
      await (0, _classPrivateFieldGet2.default)(this, _getPlatform).call(
        this,
        configuration.issuer,
        registrationResponse.client_id,
        (0, _classPrivateFieldGet2.default)(this, _ENCRYPTIONKEY),
        (0, _classPrivateFieldGet2.default)(this, _Database)
      )
    )
    ...
    const registered = await (0, _classPrivateFieldGet2.default)(
      this,
      _registerPlatform
    ).call(
      this,
      platform,
      (0, _classPrivateFieldGet2.default)(this, _getPlatform),
      (0, _classPrivateFieldGet2.default)(this, _ENCRYPTIONKEY),
      (0, _classPrivateFieldGet2.default)(this, _Database)
    );
    await (0, _classPrivateFieldGet2.default)(this, _Database).Insert(
      false,
      "platformStatus",
      {
